...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  style="text-decoration: none; font-size: 18px; font-weight: bold; color: black; " href="index.php">
        <div class="sidebar-brand-icon rotate-n-15">
          
        </div>
        <div class="sidebar-brand-text mx-3 ">OMAGA BENGKEL</div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <!-- <li class="nav-item dropdown no-arrow">
              ...
              <button class="btn btn-warning btn-user btn-block small">Checkout</button>
              </a>
            </li> -->
