        ...
        <tbody>
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td align="right"> <div class="btn-group">
                              <a type="button" class="btn btn-warning bg-gradient-warning" href="us_searchfrm.php?action=edit & id=' . $row['ID'] . '"><i class="fas fa-fw fa-list-alt"></i> Details</a>
                            <div class="btn-group">
                            ...
                            <ul class="dropdown-menu text-center" role="menu">
                                ...
                                <li>
                                <form action="us_del.php" method="POST" style="display:inline;">
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h4 class="m-2 font-weight-bold text-primary">User Accounts&nbsp;<a href="#" data-toggle="modal" data-target="#supplierModal" type="button" class="btn btn-warning bg-gradient-warning" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a></h4>
  </div>
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
