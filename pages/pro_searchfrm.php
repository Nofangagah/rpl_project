...
?>
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-warning">
        <div class="card-header py-3">
            <h4 class="m-2 font-weight-bold text-primary">Product's Detail</h4>
        </div>
        <a href="product.php?action=add" type="button" class="btn btn-warning bg-gradient-warning btn-block">
            <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Back
        </a>
        <div class="card-body">
        <?php
            $query = 'SELECT PRODUCT_ID, PRODUCT_CODE, NAME, DESCRIPTION, image, QTY_STOCK, ON_HAND, PRICE, c.CNAME 
                      FROM product p 
        ...
        ?>
            ...
            <div class="form-group row text-left">
                <div class="col-sm-3 text-primary">
                    <h5>Product Image<br></h5>
                </div>
                <div class="col-sm-9">
                    <?php
                    $imagePath = "../img/" . $f;
                    if (file_exists($imagePath)) {
                        echo '<img src="'.$imagePath.'" alt="'.$i.'" width="100" height="100"/>';
                    } else {
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"> 
                ...
                <tbody>
                <?php
                    $query = 'SELECT PRODUCT_ID, PRODUCT_CODE, NAME, QTY_STOCK, ON_HAND, CNAME, COMPANY_NAME, p.SUPPLIER_ID, DATE_STOCK_IN 
                              FROM product p 
                              JOIN category c ON p.CATEGORY_ID=c.CATEGORY_ID 
