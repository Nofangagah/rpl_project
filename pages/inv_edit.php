...
?>
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-warning">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Edit Inventory for : <?php echo $A ?></h4>
            </div>
            <a type="button" class="btn btn-warning bg-gradient-warning" href="inv_searchfrm.php?action=edit & id='<?php echo $zzz; ?>'"><i class="fas fa-fw fa-flip-horizontal fa-share"></i> Back</a>
