...
$sql = "SELECT DISTINCT CNAME, CATEGORY_ID FROM category WHERE CATEGORY_ID IN (0, 1, 2, 9)";
...
?>
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Product&nbsp;<a  href="#" data-toggle="modal" data-target="#aModal" type="button" class="btn btn-warning bg-gradient-warning" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a></h4>
            </div>
            <div class="card-body">
    ...
    $query = 'SELECT PRODUCT_ID, PRODUCT_CODE, NAME, PRICE, CNAME, DATE_STOCK_IN FROM product p join category c on p.CATEGORY_ID=c.CATEGORY_ID GROUP BY PRODUCT_CODE';
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo '<td align="right"> <div class="btn-group">
                  <a type="button" class="btn btn-warning bg-gradient-warning" href="pro_searchfrm.php?action=edit & id='.$row['PRODUCT_CODE'] . '"><i class="fas fa-fw fa-list-alt"></i> Details</a>
                <div class="btn-group">
                  <a type="button" class="btn btn-warning bg-gradient-warning dropdown no-arrow" data-toggle="dropdown" style="color:white;">
                ...
                <ul class="dropdown-menu text-center" role="menu">
                    ...
                    <li>
                      <form action="pro_delete.php" method="POST" style="display:inline;">
                        <input type="hidden" name="product_id" value="'.$row['PRODUCT_ID'].'">
                        <button type="submit" class="btn btn-danger bg-gradient-danger btn-block" style="border-radius: 0px;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="pro_transac.php?action=add">
           ...
           <div class="form-group">
             <input type="file"  min="1" max="9999999999" class="form-control" placeholder="image" name="image" required>
           </div>
           <div class="form-group">
             <?php
